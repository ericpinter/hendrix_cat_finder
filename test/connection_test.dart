...
void main() {
  ...
  test('one', () async {
    ...
    NetworkLog nl = new NetworkLog((){}, persist: false);

    var outcome = await self.send(Message(cat:null,protocol: true));
    ...
    outcome = await self.send(Message(cat:null,protocol: false));
    expect(outcome.sent, true);
